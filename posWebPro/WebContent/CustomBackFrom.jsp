		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">基本信息</strong> / <small>客户退货信息</small>
				</div>
			</div>

			<form class="am-form" method="post" action="CustomBackModify">
				<input type="hidden" name="act" value="${empty custom ? 'add' : 'mdy'}">
				<input type="hidden" name="cbid" value="${custom.cbid}">
				<div class="am-tabs am-margin" data-am-tabs>
					<ul class="am-tabs-nav am-nav am-nav-tabs">
						<li class="am-active"><a href="#tab1">${empty custom ? '新增' : '修改' }客户退货信息</a></li>
					</ul>
