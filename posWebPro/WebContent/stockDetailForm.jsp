		...
		<div class="admin-content">
			...
			<form class="am-form" method="post" action="StockDetailModify">
				<input type="hidden" name="act"
					value="${empty stockd ? 'add' : 'mdy'}"> <input
					type="hidden" name="sdid" value="${stockd.sdid}"> <input
					type="hidden" name="oldTotalprice" value="${stockd.amount}">
				<div class="am-tabs am-margin" data-am-tabs>
					<ul class="am-tabs-nav am-nav am-nav-tabs">
						<li class="am-active"><a href="#tab1">${empty stockd ? '新增' : '修改' }采购明细</a></li>
					</ul>
						...
						<div class="am-tab-panel am-fade am-in am-active" id="tab1">
							<div class="am-g am-margin-top-sm">
								...
								<div class="am-u-sm-4 am-u-end">
									<input type="number" name="sid" readonly="readonly" class="am-input-sm" value="${sid}">
								</div>
							</div>
							<div class="am-g am-margin-top-sm">
							...
							<div class="am-g am-margin-top-sm">
								...
								<div class="am-u-sm-4 am-u-end">
									<input type="number" name="totalprice" class="am-input-sm" value="${stockd.amount }">
								</div>
							</div>
							<div class="am-g am-margin-top-sm">
								<div class="am-u-sm-2 am-text-right">采购单价</div>
								<div class="am-u-sm-4 am-u-end">
									<input type="number" name="price" class="am-input-sm" value="${stockd.price }">
								</div>
							</div>
						</div>
					</div>
