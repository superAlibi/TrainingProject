		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">基本信息</strong> / <small>销售信息</small>
				</div>
			</div>

			<form class="am-form" method="post" action="SellModify">
				<input type="hidden" name="act" value="${empty sell ? 'add' : 'mdy'}">
				<input type="hidden" name="sid" value="${sell.sid}">
				<div class="am-tabs am-margin" data-am-tabs>
					...
					<div class="am-tabs-bd">
						...
						<div class="am-g am-margin-top-sm">
							<div class="am-u-sm-2 am-text-right">客户名</div>
							<div class="am-u-sm-4 am-u-end">
								<select name="cid">
									<c:forEach items="${provider}" var="p">
									<option value="${p.cid}"${p.cid eq sell.cid ? ' selected="selected"' : ''}>${p.name}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						<div class="am-g am-margin-top-sm">
							<div class="am-u-sm-2 am-text-right">销售时间</div>
							<div class="am-u-sm-4 am-u-end">
								<input type="date"  name="date" class="am-input-sm" value="${sell.date }">
							</div>
						</div>
						<div class="am-g am-margin-top-sm">
							<div class="am-u-sm-2 am-text-right">销售总价</div>
							<div class="am-u-sm-4 am-u-end">
